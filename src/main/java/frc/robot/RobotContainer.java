...
public class RobotContainer {
  ...
  //shooter
  private static SetShootPowerCmd stopShooter =  new SetShootPowerCmd(m_shooter, 0);
  private static SetShootPowerCmd startShooter =  new SetShootPowerCmd(m_shooter, 1);
